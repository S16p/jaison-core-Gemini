        ...
        match op_type:
            case OpTypes.STT:
                if op_id == "fish":
                    ...
                    from .stt.gemini import GeminiSTTOperation  # Import the new Gemini STT operation
                    return GeminiSTTOperation()
                else:
            ...
            case OpTypes.T2T:
                if op_id == "openai":
                    ...
                    from .t2t.gemini import GeminiT2TOperation  
                    return GeminiT2TOperation()
                else:
